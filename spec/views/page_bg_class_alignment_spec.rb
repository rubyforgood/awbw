...
RSpec.describe "page_bg_class alignment with policies" do
  ...
  EXPECTED_MAPPINGS = {
    ...
    "app/views/events/registrations/scholarship.html.erb" => "public",
    "app/views/events/registrations/faq.html.erb"         => "public",
    "app/views/events/registrations/payment.html.erb"     => "public",
    "app/views/events/registrations/certificate.html.erb" => "public",
    "app/views/events/registrations/ce.html.erb"          => "public",
    "app/views/events/registrations/forms.html.erb"       => "public",
    "app/views/events/registrations/handouts.html.erb"    => "public",
    "app/views/events/registrations/portal.html.erb"      => "public",
    "app/views/events/registrations/videoconference.html.erb" => "public",
