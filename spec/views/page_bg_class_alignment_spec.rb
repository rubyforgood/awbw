...
RSpec.describe "page_bg_class alignment with policies" do
  ...
  EXPECTED_MAPPINGS = {
    ...
    "app/views/events/roster.html.erb"                 => "admin-only bg-blue-100",
    ...
    "app/views/events/reports.html.erb"                => "admin-only bg-blue-100",
    "app/views/events/scholarships.html.erb"           => "admin-only bg-blue-100",
    "app/views/events/attendees.html.erb"              => "admin-only bg-blue-100",
