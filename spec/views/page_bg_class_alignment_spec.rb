...
RSpec.describe "page_bg_class alignment with policies" do
  ...
  EXPECTED_MAPPINGS = {
    ...
    "app/views/organization_types/index.html.erb"      => "admin-only bg-blue-100",
    ...
    "app/views/organization_types/show.html.erb"       => "admin-only bg-blue-100",
    ...
    "app/views/organization_types/new.html.erb"        => "admin-only bg-blue-100",
    ...
    "app/views/organization_types/edit.html.erb"       => "admin-only bg-blue-100",
