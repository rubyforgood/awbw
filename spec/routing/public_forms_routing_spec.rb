  ...
  describe "registration_form" do
    it "routes new" do
      expect(get: "/events/1/registration_form/new").to route_to(
        "events/public_forms#new", event_id: "1", form_variant: "registration"
      )
    end

    it "routes create" do
      expect(post: "/events/1/registration_form").to route_to(
        "events/public_forms#create", event_id: "1", form_variant: "registration"
      )
    end

    it "routes show" do
      expect(get: "/events/1/registration_form").to route_to(
        "events/public_forms#show", event_id: "1", form_variant: "registration"
      )
    end
  end
  ...
  describe "scholarship_form" do
    it "routes new" do
      expect(get: "/events/1/scholarship_form/new").to route_to(
        "events/public_forms#new", event_id: "1", form_variant: "scholarship"
      )
    end

    it "routes create" do
      expect(post: "/events/1/scholarship_form").to route_to(
        "events/public_forms#create", event_id: "1", form_variant: "scholarship"
      )
    end
  end
  ...
  describe "bulk_payment_form" do
    it "routes new" do
      expect(get: "/events/1/bulk_payment_form/new").to route_to(
        "events/public_forms#new", event_id: "1", form_variant: "bulk_payment"
      )
    end

    it "routes create" do
      expect(post: "/events/1/bulk_payment_form").to route_to(
        "events/public_forms#create", event_id: "1", form_variant: "bulk_payment"
      )
    end
  end
