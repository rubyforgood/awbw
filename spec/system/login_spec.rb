...
RSpec.describe "User login", type: :system do
  ...
  let(:generic_error) { "Invalid email or password. Please email us at programs@awbw.org or fill out our Contact Us form for assistance." }
  ...
  context "when user is locked" do
    ...
    it "does not allow login and shows locked message" do
      ...
      expect(page).to have_content("Please email us at programs@awbw.org or fill out our Contact Us form for assistance.")
    end
  end
