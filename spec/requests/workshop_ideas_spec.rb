...
RSpec.describe "/workshop_ideas", type: :request do
  ...
  # WorkshopIdea. As you add validations to WorkshopIdea, be sure to
  ...
  describe "GET /index" do
    it "renders a successful response" do
      WorkshopIdea.create! valid_attributes
  ...
  describe "GET /show" do
    it "renders a successful response" do
      workshop_idea = WorkshopIdea.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created workshop_idea" do
        post workshop_ideas_url, params: { workshop_idea: valid_attributes }
        expect(response).to redirect_to(workshop_idea_url(WorkshopIdea.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new WorkshopIdea" do
        ...
        }.to change(WorkshopIdea, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "redirects to the workshop_idea" do
        ...
        patch workshop_idea_url(workshop_idea), params: { workshop_idea: new_attributes }
        workshop_idea.reload
        expect(response).to redirect_to(workshop_idea_url(workshop_idea))
      end
    end
