...
RSpec.describe "Notifications", type: :request do
  ...
  describe "GET /notifications/:id" do
    ...
    context "as an admin" do
      ...
      it "renders an edit-button link to a known contact on the To side" do
        ...
        expect(to_row(response.body)).to have_link(href: edit_person_path(contact))
      end

      it "renders a noticeable person as an edit button linking to their edit page" do
        ...
        expect(noticeable_row).to have_link(href: edit_person_path(person))
      end
    end
