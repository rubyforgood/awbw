...
[
  { name: "1736 Family Crisis Center", organization_status: formerly_active_status, windows_type: adult_wt },
  ...
  { name: "YWCA Spokane", organization_status: formerly_active_status, windows_type: adult_wt },
  { name: "Center for Battered Women", organization_status: unknown_status, windows_type: children_wt },
  ...
  { name: "Joyful Heart Foundation", organization_status: formerly_active_status, windows_type: adult_wt },
  { name: "Domestic Violence Center of Santa Clarita Valley", organization_status: unknown_status, windows_type: adult_wt },
