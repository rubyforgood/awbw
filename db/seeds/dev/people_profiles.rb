...
seed_user_age_groups = {
  "umberto.user@example.com" => { primary: "Teens", additional: [ "Adults" ] },
  "amy.user@example.com" => { primary: "Children", additional: [ "Teens" ] },
  "aisha.user@example.com" => { primary: "Adults", additional: [] }
}
