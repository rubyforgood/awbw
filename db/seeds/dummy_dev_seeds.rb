...
[
  ...
  },
  {
    ...
    tips: "Make sure that the socks are the right sizes for the participants hands.<br />",
    pub_issue: "III/1",
    published: true,
    featured: true,
    searchable: true,
  ...
  },
  {
    ...
    tips: "If yarn is not available, other random art supplies, such as gel pens, markers, sequins, and gems also work.<br />",
    pub_issue: "VI/1",
    published: true,
    searchable: true,
    created_by: admin_user,
  ...
  },
  {
    ...
    tips: "When selecting boxes to decorate, be sure to purchase ones that have an unfinished surface, similar to the one from Discount School Supply. A slick, or glossy surface will not allow the paint to stick.",
    pub_issue: "XIII/7",
    published: true,
    searchable: true,
    created_by: admin_user,
