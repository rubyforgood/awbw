...
ActiveRecord::Schema[8.1].define(version: 2026_02_27_174226) do
  ...
  create_table "user_forms", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_user_forms_on_person_id"
  ...
  create_table "video_galleries", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
    t.boolean "featured", default: false, null: false
    ...
    t.datetime "updated_at", null: false
    t.string "youtube_url"
    t.index ["featured"], name: "index_video_galleries_on_featured"
    t.index ["published"], name: "index_video_galleries_on_published"
    t.index ["title"], name: "index_video_galleries_on_title"
  end
  ...
  add_foreign_key "user_forms", "people"
