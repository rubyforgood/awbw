...
ActiveRecord::Schema[8.1].define(version: 2025_11_10_163405) do
  ...
  create_table "age_ranges", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "name"
  ...
  create_table "answer_options", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "name"
    t.integer "order"
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "banners", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.text "content"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "bookmark_annotations", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "categories", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.integer "legacy_id"
  ...
  create_table "categorizable_items", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "ckeditor_assets", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "actual_url"
  ...
  create_table "event_registrations", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    ...
    t.index ["user_id", "event_id"], name: "index_event_registrations_on_user_and_event", unique: true
  ...
  create_table "facilitators", id: :integer, charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.text "bio"
    t.string "city"
    t.string "country"
    t.datetime "created_at", null: false
  ...
  create_table "faqs", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "footers", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "form_builders", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "form_field_answer_options", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "form_fields", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "forms", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "images", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "file_content_type"
    t.string "file_file_name"
    t.integer "file_file_size"
  ...
  create_table "media_files", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "file_content_type"
    t.string "file_file_name"
    t.integer "file_file_size"
    t.datetime "file_updated_at", precision: nil
  ...
  create_table "metadata", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "legacy_id"
    t.string "name"
    t.boolean "published", default: false
  ...
  create_table "monthly_reports", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "organization_workshops", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "organization_id", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "project_obligations", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "name"
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "project_statuses", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "name"
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "project_users", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "agency_id"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "quotable_item_quotes", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.integer "legacy_id"
  ...
  create_table "quotes", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "age"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "report_form_field_answers", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.text "answer", size: :medium
    t.integer "answer_option_id"
    t.datetime "created_at", precision: nil
    t.integer "form_field_id"
  ...
  create_table "resources", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "agency"
    t.string "author"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "sectorable_items", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.boolean "inactive", default: true
  ...
  create_table "sectors", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.string "name"
    t.boolean "published", default: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "stories", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
  ...
  create_table "story_ideas", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
    t.integer "created_by_id", null: false
    t.boolean "permission_given"
  ...
  create_table "user_form_form_fields", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.integer "form_field_id"
    t.text "text", size: :medium
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "user_forms", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.integer "form_id"
    t.datetime "updated_at", precision: nil, null: false
    t.integer "user_id"
  ...
  create_table "user_permissions", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "windows_types", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
    t.integer "legacy_id"
    t.string "name"
    t.string "short_name"
  ...
  create_table "workshop_age_ranges", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "workshop_ideas", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.text "age_range"
  ...
  create_table "workshop_logs", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "workshop_resources", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "workshop_variations", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "workshops", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
