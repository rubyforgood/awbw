Rails.application.routes.draw do
  ...
  get "registration/:slug/invoice/download", to: "events/registrations#invoice", as: :registration_invoice_download, defaults: { print: true }
  ...
  resources :events do
    ...
    resource :invoice, only: [ :show ], module: :events do
      get :download, action: :show, defaults: { print: true }
    end
