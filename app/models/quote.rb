class Quote < ApplicationRecord
  ...
  def self.search_by_params(params)
    ...
    quotes = quotes.sector_names_all(params[:sector_names]) if params[:sector_names].present?
    quotes = quotes.category_names_all(params[:category_names]) if params[:category_names].present?
