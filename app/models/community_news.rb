class CommunityNews < ApplicationRecord
  ...
  def self.search_by_params(params)
    ...
    community_news = community_news.sector_names_all(params[:sector_names]) if params[:sector_names].present?
    community_news = community_news.category_names_all(params[:category_names]) if params[:category_names].present?
