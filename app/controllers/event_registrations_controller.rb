class EventRegistrationsController < ApplicationController
  ...
  def index
    ...
    @registrants = Person.left_joins(:user).order(Arel.sql("LOWER(people.first_name), LOWER(people.last_name), LOWER(users.email), LOWER(people.email_2), LOWER(people.email)"))
