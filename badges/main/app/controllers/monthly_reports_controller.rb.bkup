...
# Snapshot of the controller as of commit f96a98afe (2026-03-08),
# preserved for reference during the standard-REST refactor.
class MonthlyReportsControllerOld < ApplicationController
