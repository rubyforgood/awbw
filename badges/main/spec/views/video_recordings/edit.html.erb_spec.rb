...
RSpec.describe "video_recordings/edit", type: :view do
  ...
  before(:each) do
    assign(:video_recording, video_recording)
  ...
  it "renders the edit video recording form" do
    render

    assert_select "form[action=?][method=?]", video_recording_path(video_recording), "post" do
