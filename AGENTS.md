...
- `filter_toggle` — Expand/collapse the secondary row of the shared events filter bar (events/_filters), rotating the chevron and swapping the More/Fewer filters label
